...
{
	/**
	 * Constructor for ReplyKillStatistic.
	 * @param node Node
	 */
	...
	{
		player.sendMessage("Number of killed players: " + player.getPvpCount());
		player.sendMessage("Number of killed monsters: " + player.getPveCount());
	}
}