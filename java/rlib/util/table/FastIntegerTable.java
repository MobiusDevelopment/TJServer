...
public class FastIntegerTable<V> extends AbstractTable<IntKey, V>
{
	...
	private final class TableIterator implements Iterator<V>
	{
		...
		private int index;
		final /* synthetic */ FastIntegerTable this$0;
		
		private TableIterator(FastIntegerTable fastIntegerTable)
		{
			this.this$0 = fastIntegerTable;
			Entry[] table = fastIntegerTable.table();
			if (fastIntegerTable.size > 0)
			{
