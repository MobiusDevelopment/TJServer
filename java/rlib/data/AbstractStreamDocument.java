...
{
	protected static final Logger log = Loggers.getLogger(DocumentXML.class);
	...
	public C parse()
	{
		try
		{
			...
			this.doc = factory.newDocumentBuilder().parse(this.stream);
		}
		catch (IOException | ParserConfigurationException | SAXException e)
		{
			log.warning(this, "incorrect file " + this.stream);
			log.warning(this, e);
		}
