...
public final class Matrix3f
{
	...
	{
		this.val_0_0 = Math.abs(this.val_0_0);
		this.val_0_1 = Math.abs(this.val_0_1);
		this.val_0_2 = Math.abs(this.val_0_2);
		this.val_1_0 = Math.abs(this.val_1_0);
		this.val_1_1 = Math.abs(this.val_1_1);
		this.val_1_2 = Math.abs(this.val_1_2);
		this.val_2_0 = Math.abs(this.val_2_0);
		this.val_2_1 = Math.abs(this.val_2_1);
		this.val_2_2 = Math.abs(this.val_2_2);
	}
	...
	public Vector mult(Vector vector, Vector result)
	{
		...
		float y = vector.y;
		float z = vector.z;
		result.x = (this.val_0_0 * x) + (this.val_0_1 * y) + (this.val_0_2 * z);
		result.y = (this.val_1_0 * x) + (this.val_1_1 * y) + (this.val_1_2 * z);
		result.z = (this.val_2_0 * x) + (this.val_2_1 * y) + (this.val_2_2 * z);
		return result;
	}
